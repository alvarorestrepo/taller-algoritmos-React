    ...
    <Router>
      <nav class="flex items-center justify-between flex-wrap bg-blue-500 p-6">
        <div class="flex items-center flex-shrink-0 text-white mr-6">
          <span class="font-semibold text-xl tracking-tight">React js</span>
        </div>
        ...
        <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto text-center">
          <div class="text-sm lg:flex-grow">
            <NavLink
              ...
              activeClassName="bg-white text-blue-500 font-semibold uppercase m-1 p-2 rounded-full shadow hover:text-blue-600"
            >
              Ejercicio 1
            </NavLink>
            <NavLink
